<template>
  <div class='bg-gray-800 md:inline hidden'>
    <div class='flex pb-5 px-10 m-auto pt-5 text-gray-500 text-sm border-t border-gray-900'>
      <div class='mt-2'>
        ©
        <span class='text-yellow-500 font-bold'>ULIN ADMIN</span> Copyright 2021. All Rights Reserved.
      </div>
      ...
      <div class='md:flex-auto md:flex-row-reverse mt-2 flex-row flex'>
        ...
        >
          <svg
            class='fill-current cursor-pointer text-yellow-500 hover:text-yellow-400'
            height='100%'
            style='
                        fill-rule: evenodd;
                        clip-rule: evenodd;
