<template>
	<div class='min-w-screen min-h-screen bg-gray-800'>
		<div class='w-full mx-auto px-5 py-10 text-gray-300 mb-10'>
			<div class='text-center max-w-xl mx-auto'>
				<h1 class='text-5xl font-bold mb-5'>Pricing</h1>
			...
			<div class='max-w-4xl mx-auto md:flex'>
				<div
					class='w-full md:w-1/3 md:max-w-none bg-gray-900 px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:my-6 rounded-md shadow-lg shadow-gray-600 md:flex md:flex-col'
				>
					...
					<div class='w-full'>
						<button
							class='font-bold bg-yellow-600 hover:bg-yellow-700 text-white rounded-md px-10 py-2 transition-colors w-full'
						>Buy Now</button>
					</div>
				</div>
				<div
					class='w-full md:w-1/3 md:max-w-none bg-gray-900 px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:mb-0 rounded-md shadow-lg shadow-gray-300 md:relative md:z-50 md:flex md:flex-col'
				>
					<div class='w-full flex-grow'>
					...
					<div class='w-full'>
						<button
							class='font-bold bg-yellow-500 hover:bg-yellow-600 text-white rounded-md px-10 py-2 transition-colors w-full'
						>Buy Now</button>
					</div>
				</div>
				<div
